...
class KinematicModel():
    ...
    def set_params(self, pose_abs=None, pose_pca=None, pose_glb=None, shape=None,
                   additional_verts=None,
                   additional_verts_weights=None):
        """
        ...
        if shape is not None:
            self.shape = shape
        return self.update(additional_verts, additional_verts_weights)

    def update(self, add_verts=None, add_weights=None):
        """
        ...
        if add_verts is not None:
            verts = add_verts
            self.skinning_weights = add_weights
        ...
        if self.verts.shape[0] == self.mesh_template.shape[0]:
